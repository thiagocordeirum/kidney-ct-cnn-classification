...
empregados em tarefas como a segmentação de rins e lesões tumorais e a
classificação de massas renais em exames de tomografia computadorizada,
contribuindo para diagnósticos mais rápidos e menos dependentes da experiência
subjetiva do especialista.
...
desempenho. Cada etapa é detalhada nas subseções a seguir.
...
forma estratificada nas proporções de 60\% treino (2.739 imagens), 20\%
validação (913 imagens) e 20\% teste (914 imagens), com semente aleatória
...
\multirow{3}{*}{ResNet-34}
 & Base  & 95,19 & 95,59 & 94,75 & 95,16 \\
 & CLAHE & 95,40 & 95,21 & \textbf{95,62} & 95,41 \\
 & Gama & \textbf{95,73} & \textbf{97,07} & 94,31 & \textbf{95,67} \\
\midrule
\multirow{3}{*}{ResNet-50}
 & Base  & 95,62 & 95,42 & 95,84 & 95,63 \\
 & CLAHE & 96,06 & \textbf{96,67} & 95,40 & 96,04 \\
 & Gama & \textbf{96,50} & 96,50 & \textbf{96,50} & \textbf{96,50} \\
\midrule
\multirow{3}{*}{AlexNet}
 & Base  & \textbf{98,91} & 98,48 & \textbf{99,34} & \textbf{98,91} \\
 & CLAHE & 97,16 & 96,95 & 97,37 & 97,16 \\
 & Gama & 98,80 & 98,48 & 99,12 & 98,80 \\
\midrule
\multirow{3}{*}{VGG-16}
...
(ResNet-18 e ResNet-34) e $+0{,}88$ p.p.\ (ResNet-50) sobre a condição base.
...
($+0{,}21$ p.p.\ na ResNet-34 e $+0{,}44$ p.p.\ na ResNet-50), sugerindo que
...
suave, elevou o desempenho de ambas: a AlexNet atingiu $98{,}80\%$ e a VGG-16
...
\begin{figure*}[!t]
\centerline{\includegraphics[width=\textwidth]{fig_acc_curves.png}}
...
\begin{figure*}[!t]
\centerline{\includegraphics[width=\textwidth]{fig_loss_curves.png}}
...
\begin{figure*}[!t]
\centerline{\includegraphics[width=\textwidth]{fig_confusion.png}}
...
técnica de pré-processamento mais consistente entre as avaliadas, beneficiando
ou mantendo estável o desempenho de todas as arquiteturas: os ganhos variaram
de $+0{,}21$ p.p.\ na VGG-16 a $+0{,}88$ p.p.\ na ResNet-50, com impacto
mínimo de $-0{,}11$ p.p.\ na AlexNet. O melhor resultado global foi obtido
